...
def click_find():
    ...
    if result != None:
        ...
        ent_group_input.delete('0', tk.END)
        ent_group_input.insert('0', result_of_find[4])
        ent_teacher_input.delete('0', tk.END)
        ent_teacher_input.insert('0', result_of_find[5])
...
lbl_last_name.grid(row = 1, column = 0,)
...
# Внесение Телефона 1
lbl_phone_1 = tk.Label(master = frm_form, text = 'Телефон', font = ('Calibri', 16))
ent_phone_1_input = tk.Entry(master = frm_form, width = 50)
lbl_phone_1.grid(row = 3, column = 0)
ent_phone_1_input.grid(row = 3, column = 1)

# Внесение Группы
lbl_group = tk.Label(master = frm_form, text = 'Группа', font = ('Calibri', 16))
ent_group_input = tk.Entry(master = frm_form, width = 50)
lbl_group.grid(row = 4, column = 0)
ent_group_input.grid(row = 4, column = 1)

# Внесение Преподавателя
lbl_teacher = tk.Label(master = frm_form, text = 'Преподаватель', font = ('Calibri', 16))
ent_teacher_input = tk.Entry(master = frm_form, width = 50)
lbl_teacher.grid(row = 5, column = 0)
ent_teacher_input.grid(row = 5, column = 1)
